...
def register_user(username, password):
    ...
    new_user = User(username=username, password=hash_password(password), nativeLang="English", newLang="English", proficiency="Beginner") #hash password -> encrypt the passwords before storing it
